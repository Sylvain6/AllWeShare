...
class AdminController extends AbstractController
{
    ...
    /**
     * @Route("/reports", name="_report_index", methods={"GET"})
     */
    public function report_index(ReportRepository $reportRepository): Response
    {
        return $this->render('Back/report/index.html.twig', ['reports' => $reportRepository->findAll()]);
    }
    ...
    /**
     * @Route("/report/{id}", name="_report_show", methods={"GET"})
     */
    public function report_show(Report $report): Response
    {

        return $this->render('Back/report/show.html.twig', ['report' => $report]);
    }
